...
import { CarouselComponent, CarouselSlide } from '../../components/UI/carousel.component/carousel.component';
...
<div id="hero-section" class="fullscreen">
  <app-carousel [slides]="heroSlides" [height]="'100vh'" [autoPlay]="true" [autoPlayInterval]="6000" [showArrows]="true" [showIndicators]="true"></app-carousel>
</div>
